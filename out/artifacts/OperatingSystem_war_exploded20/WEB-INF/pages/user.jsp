...
<div style="margin: 0 auto; width: 200px; text-align: center;">
    <form class="am-form" method="post" action="/user">
        ...
        <p><button type="submit" class="am-btn am-btn-primary btn-loading-example">Led on</button></p>
        <p><a href="/user" class="am-btn am-btn-primary btn-loading-example" role="button">Led Off</a></p>
    </form>
</div>
<div style="margin: 0 auto; width: 200px; text-align: center;">
    <a href="/user" class="am-btn am-btn-secondary btn-loading-example" role="button">Blinking Led</a>
</div>
<p></p>
<div style="margin: 0 auto; width: 200px; text-align: center;">
    <a href="/test3" class="am-btn am-btn-secondary btn-loading-example" role="button">Breathing Led</a>
</div>
