...
<form class="am-form" method="post" action="/test">
    ...
    <p><button type="submit" class="am-btn am-btn-primary">Led On</button></p>
    <p><a href="/test4" class="am-btn am-btn-primary" role="button">Led Off</a></p>
</form>
</div>
<div style="margin: 0 auto; width: 450px; text-align: center;">
    <a href="/test2" class="am-btn am-btn-secondary" role="button">Blinking Led</a>
</div>
<p></p>
<div style="margin: 0 auto; width: 450px; text-align: center;">
    <a href="/test3" class="am-btn am-btn-secondary" role="button">Breathing Led</a>
</div>
