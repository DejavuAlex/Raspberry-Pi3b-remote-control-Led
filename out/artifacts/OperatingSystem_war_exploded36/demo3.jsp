...
<form class="am-form" method="post" action="/test">
    ...
    <div class="effect-group-container toolbar-2">
        <a href="/brighter" class="button1" style="vertical-align:middle"><span> </span></a>
    <div class="btn-border" style="margin: 0 auto; width: 150px; text-align: center;">

        <a type="submit" class="btn btn-blue">Led on</a>
        <p></p>
        <a href="/test4" class="btn btn-red">Led off</a>

        </div>
        <a href="/dimmer" class="button2" style="vertical-align:middle"><span> </span></a>
        <p></p>
        <div class="btn-border btn-round btn-blue btn9" style="margin: 0 auto; width: 150px; text-align: center;">
            <a href="/test3" class="btn btn-black">Bliking</a>
        </div>
        <p></p>
        <div class="btn-border btn-round btn-black btn10" style="margin: 0 auto; width: 150px; text-align: center;">
            <a href="/test2" class="btn btn-green">Breathing</a>
        </div>
        <p></p>
        <div class="btn-border btn-round btn-blue btn9" style="margin: 0 auto; width: 150px; text-align: center;">
            <a href="/test5" class="btn btn-black">Bliking</a>
        </div>
